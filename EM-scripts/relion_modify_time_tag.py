...
parser.add_option("--pattern", dest="pattern", type="string", default="r'(\d{3})_(\d{2})\.(\d{2})\.(\d{2})\.mrc'", help="regex search pattern [default: %default]")
parser.add_option("--subst", dest="subst", type="string", default="r'\1_\2_\3_\4.mrc'", help="substitute pattern [default: %default]")
...
replace(options.input_star, options.output_star, options.pattern, options.subst)
