```sh
`which relion_display` --i Select/job005/micrographs.star --display rlnMicrographName --scale 0.1 --sigma_contrast 3 --black 0 --white 0 --col 4 --max_nr_images 40  --lowpass 20 --allow_save --fn_imgs Select/job017/micrographs.star  --pipeline_control Select/job017/
...
`which relion_manualpick` --i Select/job005/micrographs.star --odir ManualPick/job018/ --pickname manualpick --allow_save --fast_save --selection ManualPick/job018/micrographs_selected.star --scale 0.1 --sigma_contrast 3 --black 0 --white 0 --lowpass 20 --particle_diameter 100  --pipeline_control ManualPick/job018/
```
