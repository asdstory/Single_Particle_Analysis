...
for i in MotionCorr/job002/finished-frames/tmp/*_????????.mrc; do echo relion_image_handler --i $i --o MotionCorr/job002/finished-frames/`basename $i` --angpix 1 --rescale_angpix 10; done > runpar.cmd
